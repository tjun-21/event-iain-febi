    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $validated = $request->validate([
                ...
                'tanggal_selesai' => 'required|nullable|date|after_or_equal:tanggal_mulai',
                'batas_pendaftaran' => 'required|date',
                'batas_submission' => 'required|nullable|date',
                'status' => 'required|in:draft,published,cancelled',
                'banner_image' => 'required|nullable|image|mimes:jpeg,png,jpg,gif|max:2048',
            ]);
